...
java -cp bin -agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=42890 testbench/programs/HasNextPropertyTracer MULTIPLE 2000 2000 &

# -- 2. Attach debugger --
#  Target program is now waiting, and we want to attach
#  the tracer at the specified address.
java -cp bin:/usr/lib/jvm/java-7-openjdk-amd64/lib/tools.jar testbench/programs/tracer/TRFTracer 42890 testbench.programs.HasNextPropertyTracer main main res/has_next.trf
